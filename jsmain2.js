$(document).ready(function(){
    ...
    $('.nav-tabs a').on('shown.bs.tab', function(event){
        ...
        if(x=="Test Set 1"){
          ...
          actual.x = [(data1_t[frame][5] - 0.5)*2];
          actual.y = [(data1_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];         
          predicted.x = [(data1_t[frame][7] - 0.5)*2];
          predicted.y = [(data1_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
          ...
          actual.x = [(data2_t[frame][5] - 0.5)*2];
          actual.y = [(data2_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];          
          predicted.x = [(data2_t[frame][7] - 0.5)*2];
          predicted.y = [(data2_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
          ...
          actual.x = [(data3_t[frame][5] - 0.5)*2];
          actual.y = [(data3_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];         
          predicted.x = [(data3_t[frame][7] - 0.5)*2];
          predicted.y = [(data3_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
          ...
          actual.x = [(data4_t[frame][5] - 0.5)*2];
          actual.y = [(data4_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];           
          predicted.x = [(data4_t[frame][7] - 0.5)*2];
          predicted.y = [(data4_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
          ...
          actual.x = [(data5_t[frame][5] - 0.5)*2];
          actual.y = [(data5_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];         
          predicted.x = [(data5_t[frame][7] - 0.5)*2];
          predicted.y = [(data5_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
          ...
          actual.x = [(data6_t[frame][5] - 0.5)*2];
          actual.y = [(data6_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];        
          predicted.x = [(data6_t[frame][7] - 0.5)*2];
          predicted.y = [(data6_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
        ...
        vid.addEventListener('timeupdate',function(){
          ...
          actual.x = [(data7_t[frame][5] - 0.5)*2];
          actual.y = [(data7_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];          
          predicted.x = [(data7_t[frame][7] - 0.5)*2];
          predicted.y = [(data7_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
        ...
        vid.addEventListener('timeupdate',function(){
          ...
          actual.x = [(data8_t[frame][5] - 0.5)*2];
          actual.y = [(data8_t[frame][4] - 0.5)*2];
          actual.text = [String(Math.round(actual.x*100)/100) + " , " + String(Math.round(actual.y*100)/100)];         
          predicted.x = [(data8_t[frame][7] - 0.5)*2];
          predicted.y = [(data8_t[frame][6] - 0.5)*2];
          predicted.text = [String(Math.round(predicted.x*100)/100) + " , " + String(Math.round(predicted.y*100)/100)]; 
